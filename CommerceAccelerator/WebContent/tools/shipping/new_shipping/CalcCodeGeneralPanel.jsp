...
<%
	...
	String title;
	String panelPrompt;
	CalculationCodeDataBean calCodeBean = new CalculationCodeDataBean();
	if(newCalcCode){
		...
		panelPrompt = (String)shippingRB.get(ShippingConstants.MSG_CALCCODE_GENERAL_PANEL_PROMPT);
	  	...
	  	calCodeBean.setInitKey_calculationCodeId(calcCodeModeId);
		DataBeanManager.activate(calCodeBean);
...
%>
<SCRIPT language="JavaScript"> 
	document.writeln("<i>" + "<%=UIUtil.toHTML(calCodeBean.getCode())%>" + "</i></TD></TR>");
</SCRIPT>
<%
	}
	else{
