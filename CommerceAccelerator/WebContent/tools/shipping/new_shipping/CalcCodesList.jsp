...
<%= comm.addDlistColumn(UIUtil.toHTML(calcCode.getCode()), "javascript:changeCalcCode(" + calcCode.getCalculationCodeIdInEntityType() + ")") %>
<%	} else { %>
<%= comm.addDlistCheck(calcCode.getCalculationCodeId() + "|N", "parent.setChecked();selectCalcCode()") %>
<%= comm.addDlistColumn(UIUtil.toHTML(calcCode.getCode()), "javascript:displayCalcCode(" + calcCode.getCalculationCodeIdInEntityType() + ")") %>
<%  } %>
