...
<p class="entry_text"><%= UIUtil.toHTML((String)shippingRB.get("nameColumn")) +": " + UIUtil.toHTML(calcCode.getCode())%>
...
<% if (editable){
%>
<%= comm.addDlistColumn(UIUtil.toHTML(calcRule.getScaleCode().toString()), "javascript:changeCalcRule("+ calcRuleId +")") %>
<%  } else {
%>
<%= comm.addDlistColumn(UIUtil.toHTML(calcRule.getScaleCode().toString()), "javascript:displayCalcRule("+ calcRuleId +")") %>
<%  }
%>
<%= comm.addDlistColumn(UIUtil.toHTML(calcRule.getScaleDescription()), "none") %>
