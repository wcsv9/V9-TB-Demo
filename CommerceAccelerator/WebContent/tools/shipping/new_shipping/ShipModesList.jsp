...
<%= comm.addDlistColumn(UIUtil.toHTML(shipMode.getCarrier()), "none") %>
<%		if (shipMode.getStoreEntityIdInEntityType().equals(fStoreId)) { %>
<%= comm.addDlistColumn(UIUtil.toHTML(shipMode.getCode()), "javascript:changeShipMode(" + shipMode.getShippingModeIdInEntityType() + ")") %>
<%		} else { %>
<%= comm.addDlistColumn(UIUtil.toHTML(shipMode.getCode()), "javascript:displayShipMode(" + shipMode.getShippingModeIdInEntityType() + ")") %>
<% } %>


<%= comm.addDlistColumn(UIUtil.toHTML(field2), "none") %>
