...
for (var i=0; i<numberOfShjrules; i++) {
	...
	<% }
	%>
	addDlistColumn( escape(shjrule.<%= ShippingConstants.ELEMENT_ZONE_CODE %>), "none");
	addDlistColumn( escape(shjrule.<%= ShippingConstants.ELEMENT_SHIPMODE_CARRIER %>) + " - " +  escape(shjrule.<%= ShippingConstants.ELEMENT_SHIPMODE_CODE %>), "none");
