...
<%
	...
	JurisdictionDataBean zone = new JurisdictionDataBean();
	if (!newZone && zoneId != null && !zoneId.equals("")) {
		zone.setInitKey_jurisdictionId(zoneId);
		DataBeanManager.activate(zone);
	}
...
%>
<SCRIPT language="JavaScript">
document.writeln("<i>" + "<%=UIUtil.toHTML(zone.getCode())%>" + "</i></TD></TR>");
</SCRIPT>
<% 
	} else { 
%>
