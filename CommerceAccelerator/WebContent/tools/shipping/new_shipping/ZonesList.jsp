...
<%= comm.addDlistCheck(UIUtil.toHTML(zone.getJurisdictionId()) + "|Y", "parent.setChecked();selectZone()") %>
<%= comm.addDlistColumn(UIUtil.toHTML(zone.getCode()), "javascript:changeZone("+ zone.getJurisdictionId()+ ")") %>
<%		} else { %>
<%= comm.addDlistCheck(zone.getJurisdictionId().toString() + "|N", "parent.setChecked();selectZone()") %>
<%= comm.addDlistColumn(UIUtil.toHTML(zone.getCode()), "javascript:displayZone("+ zone.getJurisdictionId()+ ")") %>
<% } %>

<%= comm.addDlistColumn(UIUtil.toHTML(zone.getCountry()), "none") %>
<%= comm.addDlistColumn(UIUtil.toHTML(zone.getState()), "none") %>
<%= comm.addDlistColumn(UIUtil.toHTML(zone.getCity()), "none") %>
<%= comm.addDlistColumn(UIUtil.toHTML(zone.getZipcodeStart()), "none") %>
<%= comm.addDlistColumn(UIUtil.toHTML(zone.getZipcodeEnd()), "none") %>
<%= comm.endDlistRow() %>
<%
		if (rowselect == 1) {
			rowselect = 2;
