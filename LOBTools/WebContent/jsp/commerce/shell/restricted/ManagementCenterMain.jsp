...
<%
	...
	String environmentType = System.getenv("ENVTYPE");
	if (environmentType == null) {
		environmentType = "auth";
	}
	String adminConsoleRoot = com.ibm.commerce.foundation.internal.common.config.util.ConfigHelper.instance().getEnvironmentConfiguration("com.ibm.commerce.admin.console.root");
	if (adminConsoleRoot == null) {
		adminConsoleRoot = "";
	}
%>
...
<c:forEach var="aParam" items="${paramValues}">
	...
	cmcConfig.environmentType = "<%=environmentType%>";
	cmcConfig.adminConsoleRoot = "<%=adminConsoleRoot%>";
