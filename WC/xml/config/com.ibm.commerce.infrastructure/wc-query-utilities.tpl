...
<!-- ====================================================================== 
<!--	Delete entries from SRCHCONFEXT by masterCatalogId, index type, and language_id.
<!-- ======================================================================
BEGIN_SQL_STATEMENT
	name=DELETE_SRCHCONFEXT_BY_INDEXSCOP_INDEXTYPE_AND_LANGUAGES
	base_table=SRCHCONFEXT
	sql=
		DELETE FROM SRCHCONFEXT		
		WHERE INDEXSCOPE=?masterCatalogId? AND
		INDEXTYPE=?indexType? AND
...
<!-- ====================================================================== 
<!--	Find if giving masterCatalogId, indexType, indexSubType and language already exist in SRCHCONFEXT table.
<!-- ======================================================================
BEGIN_SQL_STATEMENT
	name=SELECT_SRCHCONFEXT_LANGUAGES_BY_INDEXSCOP_INDEXTYPE_INDEXSUBTYPE_LANGUAGE_ID
	base_table=SRCHCONFEXT
	sql=
		SELECT * 
			FROM SRCHCONFEXT 
		WHERE INDEXSCOPE=?masterCatalogId? AND
		INDEXTYPE=?indexType? AND
		INDEXSUBTYPE=?indexSubType? AND
		(LANGUAGE_ID = ?language_id? OR LANGUAGE_ID is null)
END_SQL_STATEMENT
