...
<!-- ====================================================================== 
	Delete the user behavior data for a user.
	@param PERSONALIZATIONID The personalization ID of the user.
=========================================================================== -->
BEGIN_SQL_STATEMENT
	name=IBM_Delete_DeleteDmuserbehavior
	base_table=DMUSERBHVR
	sql=
		DELETE FROM  
				DMUSERBHVR
		WHERE
				DMUSERBHVR.PERSONALIZATIONID IN (?PERSONALIZATIONID?)
		AND DMUSERBHVR.STOREENT_ID IN (?STOREENT_ID?)
END_SQL_STATEMENT

<!-- ====================================================================== 
	Delete the customers that are explicitly included in a member group by the customer's personalization ID.
	@param PERSONALIZATIONID The personalization ID of the user.
=========================================================================== -->
BEGIN_SQL_STATEMENT
	name=IBM_Delete_DeleteDmmbrgrppzn
	base_table=DMMBRGRPPZN
	sql=
		DELETE FROM  
				DMMBRGRPPZN
		WHERE
				DMMBRGRPPZN.PERSONALIZATIONID IN (?PERSONALIZATIONID?)
END_SQL_STATEMENT

<!-- ====================================================================== 
	Delete the time based trigger information for a user.
	@param PERSONALIZATIONID The personalization ID of the user.
=========================================================================== -->
BEGIN_SQL_STATEMENT
	name=IBM_Delete_DeleteDmtrigsnd
	base_table=DMTRIGSND
	sql=
		DELETE FROM  
				DMTRIGSND
		WHERE
				DMTRIGSND.PERSONALIZATIONID IN (?PERSONALIZATIONID?)
		AND DMTRIGSND.STOREENT_ID IN (?STOREENT_ID?)
END_SQL_STATEMENT

<!-- ====================================================================== 
	Delete the marketing experiment result information for a user.
	@param PERSONALIZATIONID The personalization ID of the user.
=========================================================================== -->
BEGIN_SQL_STATEMENT
	name=IBM_Delete_DeleteDmexplog
	base_table=DMEXPLOG
	sql=
		DELETE FROM  
				DMEXPLOG
		WHERE
				DMEXPLOG.PERSONALIZATIONID IN (?PERSONALIZATIONID?)
		AND DMEXPLOG.STOREENT_ID IN (?STOREENT_ID?)
END_SQL_STATEMENT
