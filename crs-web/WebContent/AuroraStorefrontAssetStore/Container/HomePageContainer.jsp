...
<button onclick="toggle_visibility('foo');" class="gb-close x" aria-controls="content-2" aria-expanded="true" aria-label="Close">x</button></p><p>At the same time, nothing is more important than the safety and wellness of our teams, customers and communities. We have been fortunate that  any reported cases of COVID-19 linked to a store, but based on the latest guidance from the Centers for Disease Control (CDC) and World Health Organization (WHO), we have made the decision to temporarily close all of our stores through the end of March to help prevent further spread of the coronavirus in our local communities.</p><p>Our employees will be paid throughout this period, and we will continue to serve our customers through our online business. <br>Specifically:</p><ol><li><p>You can continue to shop online as usual.is not affected by the store closure. For the safety of our employees and their families, we have however temporarily closed our distribution center until at least March 28 which will delay shipments of orders. Please bear with us during this time and we will get your order to you as soon as possible.</p></li><li><p> We will be reaching out directly to customers with existing orders to help them reschedule their order or provide them with either a gift card and an additional 20% discount or a refund. If you currently have a rental garment, please hold on to it. We will provide return instructions when our stores and distribution center reopen.</p></li><li><p><b>Future rental orders can still be placed and managed online.</b> We are ready to serve you as you prepare for future event dates. Please visit our rental pages to start your rental order.</p></li></ol><p><p>If you have any questions, our Customer Support team is ready to connect with you via chat, text, or email. We will be actively monitoring the situation and relying on guidance from the CDC, WHO and local health authorities to guide our decision on when we will reopen our stores. Thank you in advance for your understanding and continued support during this interim period.</p></p><p><p>We wish you and your loved ones good health and will provide additional updates as we have them.</p></p><strong>

<div class="footer-top-sec"><button onclick="toggle_visibility('foo');" class="gb-close text" aria-controls="content-2" aria-expanded="true" aria-label="Close">Collapse</button></div>
