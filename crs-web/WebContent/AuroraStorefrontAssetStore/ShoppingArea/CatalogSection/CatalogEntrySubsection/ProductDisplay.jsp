...
<c:if test="${productWithoutDefiningAttribute && catalogEntryDetails.numberOfSKUs eq 1}">
...
xmlns:waistate="http://www.w3.org/2005/07/aaa" lang="${shortLocale}" xml:lang="${shortLocale}">
	<head>
        ...
        <%out.flush();%>
		<c:import url = "${env_jspStoreDir}ShoppingArea/CatalogSection/CatalogEntrySubsection/PMarketingTriggerEvent.jsp" />
		<%out.flush();%>
		<flow:ifEnabled feature="FacebookIntegration">
