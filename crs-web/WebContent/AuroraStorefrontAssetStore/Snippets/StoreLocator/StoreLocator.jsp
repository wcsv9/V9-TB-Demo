...
<a id="global-message" href="#" onclick="toggle_visibility('foo');">Reduced Prices and Reopening Stores Safely - A letter to our Friends and Family  <img src="http://clipart-library.com/images/8T65ajoRc.png"></a>
...
<div class="rw text-right">
<a href="https://www.menswearhouse.com/store-locator/directory" class="location-by-state-link">STORE LOCATIONS BY STATE</a>
</div>
<c:choose>
	<c:when test="${!empty fromUrl}">
		<div class="button_footer_line no_float">
			...
			<img alt="4 For $119 Dress Shirts" src="https://images.menswearhouse.com/is/image/TMW/20-2142822-sl?scl=1&qlt=90">
		</div>
	</c:when>
